	...
	<view class="content">
	   ...
	   <view class="conterCon" :style="{'top':absHeight}">
			...
			<view class="conter conter1 ">
				...
				<u-cell-item title="常见问题" icon="setting-fill" bg-color="#ffffff"  @click='newMess'></u-cell-item>
				<u-cell-item title="联系客户" icon="setting-fill" bg-color="#ffffff"  @click='newMess'></u-cell-item>
...
<script>
	...
	export default {
		...
		methods: {
			...
			Enterprise(){
				uni.navigateTo({
					url:"/pages/shezhi/EnterpriseCertification"
				})
			},
			historys(){
				uni.navigateTo({
